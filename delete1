(async()=>{
    ...
    s4d.client.on('interactionCreate', async (interaction) => {
        ...
        database1.add(String('test'), parseInt(1));
        await interaction.reply({ content: ('added 1 database, currently at: ' + String(database1.get(String('test')))), ephemeral: true, components: [] });
      }
