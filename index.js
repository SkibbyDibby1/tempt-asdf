(async()=>{
    ...
    // blockly code
    await s4d.client.login('MTAxNjM5MjM0NTE0ODczNTYxOQ.GQXcjz.Fcc3PbDHSmfUwfH6mJin69IiBnNbAje-ZXaeX4').catch((e) => {
    ...
    s4d.client.on('interactionCreate', async (interaction) => {
        ...
        await interaction.reply({ content: 'ok', ephemeral: true, components: [] });
      }
